            ...
            <div class="toolbar hidden-print hide_print ">
                <div class="text-right">
                    <button id="printInvoice" class="btn btn-info" onclick="print()"><i class="fa fa-print"></i>
                        Imprimer</button>
                    <a class="btn btn-info" href="<?php echo e(route('voyager.commandes.index')); ?>"><i
...
<?php /**PATH /home/protein/www/admin/vendor/tcg/voyager/src/../resources/views/imprimer_commande.blade.php ENDPATH**/ ?>